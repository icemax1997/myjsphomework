  ...
  <table class="listtable">
    ...
    <% 
        ...
        %><tr>
          ...
          <td><a href="views/edit/edit_studentinfo.jsp?id=<%=stuInfo.getId() %>&table=${param.table}">修改</a>
           <a href="servlet/DeleteStudentInfo?id=<%=stuInfo.getId()%>&table=${param.table}">删除</a></td>  
        </tr>
        <%
        }
         %>
