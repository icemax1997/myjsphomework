...
<html>
  ...
  List<String[]> list = du.getPageData(table,pageSize, currentPage);
   %>
	...
	<div class="page">
          <div class="myreach">
           <a href="record_del.jsp?currentPage=<%=currentPage+1 %>&table=<%=table %>&power=<%=power %>" id="fl-r">下一页</a>
              <a href="record_del.jsp?currentPage=<%=currentPage-1%>&table=<%=table %>&power=<%=power %>" id="fl-r">上一页</a>
