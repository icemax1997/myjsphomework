    ...
    <% 
       ...
       MarkInfo markInfo=almark.get(i);
        ...
        %><tr>
          ...
          <td><a href="edit_mark.jsp?id=<%=markInfo.getId() %>&table=<%=table%>">修改</a>
           <a href="servlet/DeleteMark?id=<%=markInfo.getId()%>&table=<%=table%>">删除</a></td>  
        </tr>
        <%
        }
         %>
   	...
   	<div class="page">
          <div class="myreach">
           <a href="mark.jsp?table=<%=table%>" id="fl-r">返回</a>
