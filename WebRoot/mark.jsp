            ...
            <a href="" class="nav-list-navigation">采购管理</a>
                ...
                <li id="yourpower">
                    ...
                    <ul>
                        ...
                        <li><a href="users_up.jsp?table=users&power=<%=power%>">权限设置</a></li>
                    </ul>
                </li>
                </ul>
        </div>
      ...
      <div> <input type="submit" value="搜索" id="querysubmit" style="color: #fff;"></div>
                   ...
                   <form method="post" action="servlet/PatchDeleteStudentInfo?table=<%=table %>">
		            ...
		            <div class="baras">
			                ...
			                <a href="toexcel2.jsp?table=<%=table %>">导出为Excel</a>
			                <a href="toword2.jsp?exportToWord=YES&table=<%=table %>">导出为Word</a>
   ...
   %>
	...
	<table class="listtable">
            ...
            <tr>
                ...
                <td><a href="edit_mark.jsp?id=<%=temp[0]%>&table=<%=table%>">修改</a>
                    <a href="servlet/DeleteMark?id=<%=temp[0]%>&table=<%=table%>">删除</a>
                </td>
            </tr>
            <%} %>
        </table>
	...
	<div class="page">
          <div class="myreach">
           <a href="mark.jsp?currentPage=<%=currentPage+1 %>&table=<%=table %>" id="fl-r">下一页</a>
              <a href="mark.jsp?currentPage=<%=currentPage-1%>&table=<%=table %>" id="fl-r">上一页</a>
