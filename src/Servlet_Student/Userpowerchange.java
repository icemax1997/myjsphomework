...
public class Userpowerchange extends HttpServlet {

	/**
		 * Constructor of the object.
		 */
	public Userpowerchange() {
		super();
	}
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String[] ids=request.getParameterValues("ch1");
		...
		int flag=0,flag2=0;
		try{
			flag=stuLogic.PowerChange(table,ids);
			flag2=stuLogic.PowerChange2(table,ids);
